...
export default function Navbar() {
    ...
    return (
        <div className="navbar-container">
            ...
            <header className={`flex items-center justify-between h-16 p-6 py-4 md:px-8 fixed w-full shadow-xl z-100 transition-all duration-300 ${scrolling ? 'scrolled' : 'bg-transparent'}`}>
